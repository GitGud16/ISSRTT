...
declare module '$env/static/private' {
	...
	export const COMPONENT_INSTALLER_DIR: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		COMPONENT_INSTALLER_DIR: string;
		COMPUTERNAME: string;
		ComSpec: string;
		CUDA_PATH: string;
		...
		DriverData: string;
		EDGE_BROWSER_PID: string;
		EDGE_CRASHPAD_PIPE_NAME: string;
		EDGE_METRICS_CLIENT_ID_HASH: string;
		EDGE_METRICS_SESSION_ID: string;
		EDGE_RUNTIME_VARIATIONS_SEED_ETAG: string;
		EDGE_USER_DATA_DIR: string;
		EDGE_UX_CONFIG_CORRELATION_ID: string;
		EDGE_VARIATIONS_SEED_ETAG: string;
		EDITOR: string;
		EFC_7680: string;
